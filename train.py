...
def main(args):
    ...
    if args.pretrained and not args.resume:
        ...
        model_loaded = eval(model_name).from_pretrained(get_local_path(args.resume)).to(device)
        print('Loading resume: ', args.resume, model_name) #      
        state_dict_loaded = model_loaded.state_dict()
        model.load_state_dict(state_dict_loaded, strict=False)
        model_without_ddp = model

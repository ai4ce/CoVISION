...
struct RenderTarget::Impl {
  Impl(const Mn::Vector2i& size,
    ...
    // std::cout << "Constructing RenderTarget::Impl" << std::endl;
    if (depthShader_) {
	    // std::cout << "Working with depth shader" << std::endl;
    ...
    if (flags_ & Flag::RgbaAttachment) {
	    // std::cout << "Working with RGBA attachment" << std::endl;
      colorBuffer_.setStorage(Mn::GL::RenderbufferFormat::RGBA8, size);
    }
    if (flags_ & Flag::ObjectIdAttachment) {
	    // std::cout << "Working with object attachment" << std::endl;
    ...
    if (flags_ & Flag::DepthTextureAttachment) {
	    // std::cout << "Working with depth texture attachment" << std::endl;
      depthRenderTexture_.setMinificationFilter(Mn::GL::SamplerFilter::Nearest)
	    ...
	    // std::cout << "Working without depth texture attachment and use unprojectedDepth_ as depth buffer" << std::endl;
  ...
  void readFrameRgba(const Mn::MutableImageView2D& view) {
    // std::cout << "Reading frame rgba" << std::endl;
...
RenderTarget::RenderTarget(const Mn::Vector2i& size,
    ...
    : pimpl_(spimpl::make_unique_impl<Impl>(size,
                                            ...
                                            flags,
                                            visualSensor)) {
	    // std::cout << "Constructing RenderTarget" << std::endl;
    }

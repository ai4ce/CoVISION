...
PbrShader::PbrShader(const Configuration& config)
  ...
  setUniform(uniformLocation("camera1DepthTexture"),
		  pbrTextureUnitSpace::TextureUnit::Depth);
  ...
  useDepthTexture_ = uniformLocation("useDepthTexture");
  getBinaryImage_ = uniformLocation("getBinaryImage");
  camera1ViewMatrix_ = uniformLocation("camera1ViewMatrix");
  camera1ProjectionMatrix_ = uniformLocation("camera1ProjectionMatrix");
  camera1NearPlane_ = uniformLocation("camera1NearPlane");
  camera1FarPlane_ = uniformLocation("camera1FarPlane");
...
PbrShader& PbrShader::bindDepthTexture(Magnum::GL::Texture2D& depth) {
  depth.bind(pbrTextureUnitSpace::TextureUnit::Depth);
  return *this;
}

PbrShader& PbrShader::setUseDepthTexture(const bool useDepthTexture) {
  setUniform(useDepthTexture_, useDepthTexture);
  return *this;
}

PbrShader& PbrShader::setGetBinaryImage(const bool getBinaryImage) {
  setUniform(getBinaryImage_, getBinaryImage);
  return *this;
}

PbrShader& PbrShader::setCam1ViewMatrix(const Mn::Matrix4& matrix) {
  setUniform(camera1ViewMatrix_, matrix);
  return *this;
}
PbrShader& PbrShader::setCam1ProjectionMatrix(const Mn::Matrix4& matrix) {
  setUniform(camera1ProjectionMatrix_, matrix);
  return *this;
}
PbrShader& PbrShader::setCam1NearPlane(float near) {
  setUniform(camera1NearPlane_, near);
  return *this;
}
PbrShader& PbrShader::setCam1FarPlane(float far) {
  setUniform(camera1FarPlane_, far);
  return *this;
}

...
class PbrShader : public Magnum::GL::AbstractShaderProgram {
 public:
  ...
  PbrShader& bindDepthTexture(Magnum::GL::Texture2D& depth);

  // ======== set uniforms ===========

  PbrShader& setUseDepthTexture(const bool);
  PbrShader& setGetBinaryImage(const bool);
  PbrShader& setCam1ViewMatrix(const Magnum::Matrix4& matrix);
  PbrShader& setCam1ProjectionMatrix(const Magnum::Matrix4& matrix);
  PbrShader& setCam1NearPlane(float near);
  PbrShader& setCam1FarPlane(float far);
  /**
 ...
 protected:
  ...
  // ======= uniforms =======
  int useDepthTexture_ = ID_UNDEFINED;
  int getBinaryImage_ = ID_UNDEFINED;
  int camera1ViewMatrix_ = ID_UNDEFINED;
  int camera1ProjectionMatrix_= ID_UNDEFINED;
  int camera1NearPlane_ = ID_UNDEFINED;
  int camera1FarPlane_ = ID_UNDEFINED;

...
RenderCamera::RenderCamera(scene::SceneNode& node,
  ...
  // std::cout << "Constructing RenderCamera" << std::endl;
...
RenderCamera::RenderCamera(scene::SceneNode& node,
  ...
  // std::cout << "Constructing RenderCamera with MN vectors" << std::endl;
...
RenderCamera& RenderCamera::setOrthoProjectionMatrix(int width,
                                                     ...
                                                     float zfar,
                                                     float scale) {
  // std::cout << "Setting Orthognal ProjMaxtrix" << std::endl;
...
uint32_t RenderCamera::draw(DrawableTransforms& drawableTransforms,
                            Flags flags) {
  // std::cout << "Drawing with RenderCamera" << std::endl;

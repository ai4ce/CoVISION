...
out highp vec4 camera1ClipSpace;

// Camera1 matrices
uniform highp mat4 camera1ViewMatrix;
uniform highp mat4 camera1ProjectionMatrix;
...
// See Magnum phong.vert for source of this code
  ...
  camera1ClipSpace = camera1ProjectionMatrix * camera1ViewMatrix * vertexWorldPosition;
